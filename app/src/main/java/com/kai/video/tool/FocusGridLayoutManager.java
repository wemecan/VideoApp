...
public class FocusGridLayoutManager extends GridLayoutManager {
    ...
    public View onInterceptFocusSearch(View focused, int direction) {
        ...
        if (direction == View.FOCUS_DOWN || direction == View.FOCUS_UP) {
            ...
            if (direction == View.FOCUS_DOWN && currentPosition > lastVisiblePosition) {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(focused.getContext());
            ...
            if (direction == View.FOCUS_UP && currentPosition < firstVisiblePosition){
                Log.i("tag", "onInterceptFocusSearch: update...");
                RecyclerView.SmoothScroller smoothScroller = new LinearTopSmoothScroller(focused.getContext());
                smoothScroller.setTargetPosition(currentPosition);
                startSmoothScroll(smoothScroller);
    ...
    private OnReachHeader onReachHeader;

    public void setOnReachHeader(OnReachHeader onReachHeader) {
        this.onReachHeader = onReachHeader;
    }
